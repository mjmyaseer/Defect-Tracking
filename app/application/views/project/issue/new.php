<h3>
	<?php echo __('manageit.create_a_new_issue'); ?>
	<span><?php echo __('manageit.create_a_new_issue_in'); ?> <a href="<?php echo $project->to(); ?>"><?php echo $project->name; ?></a></span>
</h3>
...
<div class="pad">
	...
	<form method="post" action="">
		...
		<table class="form" style="width: 100%;">
			...
			<tr>
				<th><?php echo __('manageit.issue'); ?></th>
				<td>
			...
			<tr>
				<th><?php echo __('manageit.assigned_to'); ?></th>
				<td>
			...
			<?php endif; ?>
			<tr>
<!--				<th>--><?php //echo __('manageit.attachments'); ?><!--</th>-->
<!--				<td>-->
...
<!--				</td>-->
			...
			<tr>
				<th></th>
				<td><input type="submit" value="<?php echo __('manageit.create_issue'); ?>" class="button primary" /></td>
			</tr>
		</table>
