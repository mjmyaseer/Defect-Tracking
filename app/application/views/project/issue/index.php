<h3>
	...
	<span><?php echo __('manageit.on_project'); ?> <a href="<?php echo $project->to(); ?>"><?php echo $project->name; ?></a></span>
</h3>
		...
		<li>
			<div class="insides">
				<div class="topbar">
					...
					<?php echo __('manageit.opened_this_issue'); ?>  <?php echo date('F jS \a\t g:i A', strtotime($issue->created_at)); ?>
				</div>
		...
		<?php if(Auth::user()->permission('issue-modify')): ?>
			...
			<ul class="issue-actions">
				<li class="assigned-to">
					<?php echo __('manageit.assigned_to'); ?>
					...
					<?php else: ?>
						<a href="javascript:void(0);" class="currently_assigned">
							<?php echo __('manageit.no_one'); ?>
						</a>
					<?php endif; ?>

					<div class="dropdown">
						<ul>
							<li class="unassigned"><a href="javascript:void(0);" onclick="issue_assign_change(0, <?php echo Project\Issue::current()->id; ?>);" class="user0<?php echo !Project\Issue::current()->assigned ? ' assigned' : ''; ?>"><?php echo __('manageit.no_one'); ?></a></li>
				...
				<li>
					<a href="<?php echo Project\Issue::current()->to('status?status=0'); ?>" onclick="return confirm('<?php echo __('manageit.close_issue_confirm'); ?>');" class="close"><?php echo __('manageit.close_issue'); ?></a>
				</li>
			</ul>
		<?php endif; ?>

		<h4>
			<?php echo __('manageit.comment_on_this_issue'); ?>
		</h4>
...
<!--			</p>-->
			...
			<p style="margin-top: 10px;">
				<input type="submit" class="button primary" value="<?php echo __('manageit.comment'); ?>" />
			</p>
	...
	<?php else: ?>
	<?php echo HTML::link(Project\Issue::current()->to('status?status=1'), __('manageit.reopen_issue')); ?>
	<?php endif; ?>
</div>
