<h3>
	<?php echo __('manageit.my_settings'); ?>
	<span><?php echo __('manageit.my_settings_description'); ?></span>
</h3>
...
<!--			<tr>-->
<!--				<th>--><?php //echo __('manageit.language') ; ?><!--</th>-->
<!--				<td>-->
...
<!--			</tr>-->
			...
			<tr>
				...
				<td>
					<input type="password" name="password" id="password" value="" autocomplete="off" style="width: 300px;" />
