<h3>
	<?php echo __('manageit.your_issues'); ?>
	<span><?php echo __('manageit.your_issues_description'); ?></span>
</h3>
			...
			<ul class="issues">
				...
				<li>
					...
					<div class="data">
						...
						<div class="info">
							<?php echo __('manageit.raised_by'); ?>
							...
							- <?php echo __('manageit.updated_by'); ?> <strong><?php echo $row->updated->firstname . ' ' . $row->updated->lastname; ?></strong>
